...
// Layout Styles
pub const APP_CONTAINER: &str =
    "min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 sm:p-8";
...
pub const CARD_TITLE: &str =
    "text-2xl font-semibold mb-6 text-gray-800 border-b border-gray-200 pb-2";
