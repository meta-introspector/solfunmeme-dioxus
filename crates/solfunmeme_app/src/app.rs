use solfunmeme_app::header::Header;
use dioxus::prelude::*;

use model_lib::{NotificationInfo};
use views_lib::{footer::Footer, notification::Notification, page_not_found::PageNotFound};

use model_lib::{AccountState};
use views_lib::connections::Connections;
...
use model_lib::storage::{ACCOUNT_STATE, ACTIVE_CONNECTION, GLOBAL_MESSAGE, WALLET_ADAPTER};
